...
<Div>
    <div class="row py-1 text-center">
        <h5 class="h5 mb-3 fw-normal">Your favorites crypto-currencies :</h5>
                                ...
                                <div class="col offset-4">
                                    <c:forEach items="${sessionScope.user.favoriteCurrencies}" var="currency">
                                        ...
                                        <form action="/user/home" method="get">
                                            ...
                                            <button class="w-100 btn btn-lg btn-primary" type="submit" name="showCurrency" id="showCurrency">SHOW</button>
                                        </form>
                                    </c:forEach>
                                </div>
                            </div>
